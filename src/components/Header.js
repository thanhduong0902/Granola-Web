        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <MdAccountCircle
              ...
              className=" text-2xl drop-shadow-xl cursor-pointer text-white"
              //alt="userprofile"
              onClick={showMenu}
            />
            {isMenu && (
              ...
              >
                ...
                {user && user.email === "phamthuy9a1pcx3@gmail.com" && (
                  ...
                  >
                    <p
                      className="px-4 py-2 flex items-center gap-3  text-textColor text-base"
                ...
                {!user && (
                  <Link to="/signin">
                    <div
                      ...
                      className="flex  flex-row items-center justify-between cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out"
                    >
                      <p className="px-4 py-2 flex items-center gap-3  text-textColor text-base">
                        Đăng nhập/ Đăng kí
                      </p>
                      <MdLogout className="mr-2" />
                    </div>
